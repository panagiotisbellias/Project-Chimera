# =============================================================================
# quant_better_report.py (Final Version)
#
# Description:
...
def generate_final_report():
    ...
    output_path = "results/quant/Chimera_Performance_Report_Final.png"
    plt.savefig(output_path, dpi=300)
    print(f"\n✅ Enhanced and CORRECTED report saved to '{output_path}'")
    plt.show()

if __name__ == '__main__':
    if os.path.exists("results/quant/final_backtest_history.csv") and os.path.exists("results/quant/final_backtest_actions.csv"):
